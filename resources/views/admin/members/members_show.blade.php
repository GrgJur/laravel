                        ...
                        <table class="table table-striped responsive-table" id="dt">
                            ...
                            @foreach ($members as $member)
                                <tr>
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{ route('members.show',$member) }}" class="btn btn-info btn-xs"><i class="fa fa-eye" title="{{__('member.show')}}"></i></a>
                                    </td>
                                    <td>
                                        <a href="{{ route('members.edit',$member) }}" class="btn btn-info btn-xs edit"><i class="fa fa-pencil" title="{{__('member.edit')}}"></i></a>
                                    </td>
                                    <td>
                                        <form class="delete" action="{{ route('members.destroy',$member) }}" method="POST">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
