                        ...
                        <table class="table table-striped responsive-table" id="dt">
                            ...
                            <?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('payments.details', ['id' => $payment->id])); ?>" class="btn btn-info btn-xs"><i class="fa fa-eye" title="<?php echo e(__('payment.details')); ?>"></i></a>
                                    </td>
                                    <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jure/backup/sg8000/resources/views/admin/payments/payments_show.blade.php ENDPATH**/ ?>