...
<script type="text/javascript" src="<?php echo e(asset('js/datetimepicker/bootstrap-datetimepicker.js')); ?>" charset="UTF-8"></script>

<script src="<?php echo e(asset('js/jQuery/jquery-ui.min.js')); ?>" charset="UTF-8"></script>
<link rel="stylesheet" href="<?php echo e(asset('css/jquery-ui.css')); ?>">

<link href=<?php echo e(asset('css/bootstrap-datetimepicker.css')); ?> rel="stylesheet" media="screen">
<script type="text/javascript" src="<?php echo e(asset('js/datetimepicker/locales/bootstrap-datetimepicker.it.js')); ?>" charset="UTF-8"></script>

<script src="<?php echo e(asset('plugins/table-edits/table-edits.min.js')); ?>" charset="UTF-8"></script>

<link rel="stylesheet" href="<?php echo e(asset('css/sg3000.css')); ?>">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.responsive-table').DataTable({
            ...
            "ordering": false,
            "language": {
                "url": "<?php echo e(asset('/plugins/datatables/lang').'/'.Config::get('app.locale').'.json'); ?>"
            }
        });
...
<script type="text/javascript">
    $(".delete").on("submit", function(){
        return confirm('<?php echo e(__('member.sure_to_delete')); ?>');
    });
...
<script type="text/javascript">
    ...
    var table = $('#datatable-member').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '<?php echo e(route('lessons.getMembers')); ?>',
        columns: [
            { data: 'nip', name: 'nip' },
    ...
    function addMemberToLesson(id,np,first,last,birth)
    {
        ...
        if(!$('#'+present).length) {
            if (rowCount <= maxMembers) {
                ...
                allCourses.innerHTML = "<input type=checkbox value="+id+" id=memberAllLesson"+id+" name=memberAllLesson[]> <?php echo e(__('lesson.add_member_in_every_course')); ?></input>";
                ...
                remove.innerHTML = "<a class='btn btn-primary'><i class='fa fa-trash-o' title='<?php echo e(__('member.detach')); ?>'></i></a>";
            }
            else {
                return alert('<?php echo e(__('lesson.cannot_add_more_members')); ?>');
            }
        }
        else {
            return alert('<?php echo e(__('lesson.member_present')); ?>');
        }
    }
    ...
    var table = $('#datatable-member-direct').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '<?php echo e(route('lessons.getMembersDirect')); ?>',
        columns: [
    ...
    function addMemberToLessonDirect(id)
    {
        ...
        $.ajax({
            ...
            url: '<?php echo e(URL::to("admin/lessons/addMember/licenseMemberId")); ?>', // This is the url we gave in the route
            ...
            success: function(response){ // What to do if we succeed
                ...
                if ($.trim(response)) {
                    ...
                    update.innerHTML ="<a class='btn btn-info btn-xs edit' title='<?php echo e(__('member.edit')); ?>'> <i class='fa fa-pencil'></i> </a>";
    ...
    function validateLessonsCreateForm() {
        ...
        if (dateValue == "") {
            ...
            datetimeErrorDiv.innerHTML= '<?php echo e(__('lesson.datetime_not_present')); ?>';
    ...
    $("#actual-member tr").editable({
        ...
        edit: function (values) {
            $(".edit i", this)
                ...
                .addClass('fa-save')
                .attr('title', '<?php echo e(__('member.save')); ?>');
        },
...
//TODO bottone edit non va sugli elememti creati dal JS
                method: 'POST',
                url: '<?php echo e(URL::to("/admin/lessons/editLessonLicenseMember")); ?>',
        ...
        cancel: function(values) {
            $(".edit i", this)
                .removeClass('fa-save')
                .addClass('fa-pencil')
                .attr('title', '<?php echo e(__('member.edit')); ?>');
        }
    ...
    var table = $('#datatable-show-lessons').DataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: '<?php echo e(route('members.getAvailablesLessons')); ?>',
        columns: [
    ...
    function addMemberIntoLesson(id)
    {
        ...
        $.ajax({
            method: 'POST', // Type of response and matches what we said in the route
            url: '<?php echo e(URL::to("/admin/members/addLesson/lessonId")); ?>',
            data: {'lessonId' : id},
            success: function(response){ // What to do if we succeed
                $('#membersModal').modal('hide');
                location.reload();
...
<?php /**PATH /Users/damir/Projects/larajure/resources/views/layouts/partials/footer-scripts.blade.php ENDPATH**/ ?>