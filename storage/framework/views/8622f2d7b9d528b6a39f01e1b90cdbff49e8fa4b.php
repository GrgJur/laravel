...
<div>
    ...
    <form action="<?php echo e(route('statistics.show')); ?>" method="post">
    	...
    	<select name="graphic" style="float: left;">
			...
			<option value="5">Ratio allievi/licenze</option>
	    </select>
...
<?php if(isset($id)): ?>
	...
	<?php elseif($id == 5): ?>
		<?php echo $__env->make('admin.statistics.statistics_graphic_ratio_members-licenses', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	<?php endif; ?>
<?php endif; ?>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/jure/backup/sg8000/resources/views/admin/statistics/statistics_show.blade.php ENDPATH**/ ?>