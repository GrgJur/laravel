...
<body>
    ...
    <div style="float: left; margin: 4px"><a href="<?php echo e(route('homepage.index')); ?>">HOME</a></div>

    <div style="float: left; margin: 4px"><a href="<?php echo e(route('admin.logout')); ?>">LOGOUT</a></div>
		...
		var app = Vue.createApp({
		    ...
		    methods: {
		    	onSubmit() {
		    		...
		    		const titolo = 'Messaggio inviato da <?php echo e(auth()->user()->firstname); ?> a ' + membro.firstname;
...
<?php /**PATH /Users/damir/Projects/larajure/resources/views/admin/messages/message.blade.php ENDPATH**/ ?>