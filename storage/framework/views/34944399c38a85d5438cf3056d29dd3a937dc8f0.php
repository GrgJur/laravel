        ...
        <?php if(count($courses) > 0): ?>
            ...
            <div class="pull-left">
                <a class="btn btn-success"
                   href="<?php echo e(route('courses.create',['type'=>$typ])); ?>"><?php echo e(__('course.create')); ?></a>
            </div>
            ...
            <?php $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="pull-right">
                    ...
                    <form action=" <?php echo e(route('courses.destroy',['course'=>$course->id])); ?>" method="POST"
                        ...
                        <button class="btn btn-danger btn-xs btn-delete">
                            <i class="fa fa-trash-o" title="<?php echo e(__('course.delete')); ?>"></i>
                        </button>
                    </form>
                </div>
                <hr>
                ...
                <div class="collapse show" id="<?php echo e($course->id); ?>">
                    <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="<?php echo e(route('lessons.edit',['lesson'=>$lesson->id])); ?>"
                        ...
                        <?php if((count($course->lessons)<($course->type->number_lessons))): ?>
                            <div class="pull-right" style="display:inline;margin:2px;padding:2px;">
                                <a class="btn btn-success"
                                   href="<?php echo e(route('lessons.create',['idCourse'=>$course->id,'type'=>$typ])); ?>" ><i
                                            class="fa fa-plus-circle" aria-hidden="true" title="<?php echo e(__('lesson.add')); ?>"></i></a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/damir/Projects/larajure/resources/views/admin/lessons/lessons_show.blade.php ENDPATH**/ ?>